  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 22, color: 'rgba(255,255,255,0.65)', fontSize: 12 }} className="bp-hide-mobile">
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
            <span style={{ width: 5, height: 5, borderRadius: '50%', background: '#3DBA6E', display: 'inline-block' }} />
